...
- 然而，極右翼政黨興起的成因錯綜複雜，我們觀察德國 16 邦於 2025 年德國聯邦議院選舉，各邦得票率最高之政黨示意圖，發現存在 AfD 於前東德五邦中的支持率遠高過前西德各邦的現象。
- 因此，本研究將以 **「前東德/前西德」這個角度切入分析極右翼政黨興起的成因**。
![](/images/2025_German_federal_election_States.svg "Attendance info should be truncated before NLP")
## 2.轉換成統計問題
